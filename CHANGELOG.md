...
- Fix X-series height writes by sending numeric millimetres to the mower and retaining hexadecimal text only for X-series cloud persistence.
- Preserve the confirmed i-series robot and cloud write formats.
