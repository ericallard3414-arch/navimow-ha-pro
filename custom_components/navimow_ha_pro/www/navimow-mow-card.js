 ...
 * sensor's `zones` attribute. Backed by the navimow_ha_pro.mow service.
 */
...
class NavimowMowCard extends HTMLElement {
  ...
  async _mow() {
    ...
    try {
      await this._hass.callService("navimow_ha_pro", "mow", data);
...
window.customCards.push({
  ...
  description: "Start mowing now (zone + restart/continue) via a popup, for the Navimow HA Pro integration.",
  preview: false,
});
